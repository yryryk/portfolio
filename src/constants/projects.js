  ...
  educationalProjects: [
    {
      ...
      techs: 'React, Express, MongoDB, JWT.',
      preview: Mesto,
  ...
  petProjects: [
    {
      id: 0,
      name: 'Learn keyboard',
      about: 'Это десктопное веб-приложение для обучения слепой печати на клавиатуре. Вам предоставляется случайный символ, и вы должны нажать его на клавиатуре. На экране отображается изображение клавиатуры с нажатой клавишей и той, которую необходимо нажать. Стрелка между ними указывает на правильное направление.',
      note: 'Язык клавиатуры может быть RU или ENG(US). Случайные символы появляются в самописной карусели барабанного типа',
      techs: 'React, Canvas.',
